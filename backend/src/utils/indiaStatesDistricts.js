const INDIA_STATES_DISTRICTS = {
  "Andhra Pradesh": [
    "Ananthapuramu", "Chittoor", "East Godavari", "Guntur", "Kadapa",
    "Krishna", "Kurnool", "Nandyal", "NTR", "Palnadu", "Prakasam",
  ...
  "Arunachal Pradesh": [
    ...
    "Lepa Rada", "Lhit", "Longding", "Lower Dibang Valley", "Lower Subansiri",
  ...
  "Chhattisgarh": [
    ...
    "Surajpur", "Surguja", "Khairagarh-Chhuikhadan-Gandai", "Sarangarh-Bilaigarh"
  ],
  "Goa": [
    "North Goa", "South Goa"
  ],
  ...
  "Maharashtra": [
    "Ahmednagar", "Akola", "Amravati", "Chhatrapati Sambhaji Nagar", "Bhandara",
    "Beed", "Buldhana", "Chandrapur", "Dhule", "Gadchiroli", "Gondia",
  ...
  "Sikkim": [
    "Gangtok", "Gyalshing", "Pakyong", "Soreng", "Mangan", "Namchi"
  ],
  "Tamil Nadu": [
  ...
  "Telangana": [
    "Adilabad", "Bhadradri Kothagudem", "Hanamkonda", "Hyderabad", "Jtial",
...
function isValidState(state) {
  return Boolean(state && INDIA_STATES_DISTRICTS.hasOwnProperty(state.trim()));
}

function isValidDistrictForState(state, district) {
  if (!isValidState(state) || !district) return false;
  const districts = INDIA_STATES_DISTRICTS[state.trim()];
